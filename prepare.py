...
config = {'train_data_path': ['data/raw_files/subset0/',
          ...
          'train_preprocess_result_path': 'data/raw_npz/',
          # 'train_preprocess_result_path': 'data/preprocessed/',
          # contains numpy for the data and label, which is generated by prepare.py
          'val_preprocess_result_path': 'data/raw_npz/',
          # 'val_preprocess_result_path': 'data/preprocessed/',
          # make sure copy all the numpy into one folder after prepare.py
          'test_preprocess_result_path': 'data/raw_npz/',
          ...
          'preprocess_result_path': 'data/raw_npz/',
